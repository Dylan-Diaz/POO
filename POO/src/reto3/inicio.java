...
public class inicio {
    public static void main(String[] args) {
        ...
        empleado emp=new empleado(per.getTipoDoc(),per.getDocumento(),per.getApellido(),per.getNombre(),
        per.getEdad(),per.getEstatura(),per.getPeso(),per.getSexo());
        ...
        System.out.println("el cargo del empleado es:"+emp.getCargo()+","+emp.getNombre()+","+emp.getApellido()
        +","+emp.getDocumento()+","+emp.getTipoDoc()+","+emp.getValorHora()+","+emp.getHorasTrabajadas());
