...
public class empleado extends persona3 {
    ...
    public empleado(String tipoDoc,int documento,String nombre,String apellido,int peso,int estatura,
    ...
    public void mostrarEmpleado() {
        System.out.println("Los datos del empleado son:_"+getTipoDoc()+","+getDocumento()+","+getNombre()+","
        +getApellido()+","+getPeso()+","+getEstatura()+","+getEdad()+","+getSexo());
    }
